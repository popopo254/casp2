...
const getP7 = `
    SELECT 
    projects.project_id, projects.project_type ,projects.project_data_ref, project_data.project_data_p_6,project_data.project_data_p_7
FROM projects 
...
const ST_Get_P7 = (data,callback) =>{
    ...
    db.query(getP7,[project_id,project_user,project_type],(err,result)=>{
        ...
        //console.log("Get_P7 :",result)
        callback(null,result)
    })
}

module.exports = ST_Get_P7