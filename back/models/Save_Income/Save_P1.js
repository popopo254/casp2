...
const insertProjectData = `INSERT INTO project_data (project_id,project_data_p_1) VALUES (?,?)`; //1
const updateProjectRef = `UPDATE projects SET project_data_ref = ? WHERE project_id = ?`;
const updateProjectData = `UPDATE project_data SET project_data_p_1 = ? WHERE project_id = ?`; //2

const Save_P1 = (data, callback) => {
    ...
    //console.log("after stringify :",projectData)
